<x-layouts.front>
    ...
    <div class="container py-[150px]">
        <div class="text-center">
            <h2 class="font-display2 text-9xl leading-tight font-bold text-gray-black">404</h2>
            <p class="font-display2 text-3xl leading-tight font-bold text-gray-black pb-5 capitalize">
                Oops! Page not
                found</p>
            <p class="font-display2 text-lg leading-tight font-normal text-gray-500 ">The page
