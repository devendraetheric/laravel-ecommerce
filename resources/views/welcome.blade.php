<x-layouts.front>
                    ...
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        ...
                        <div class="md:w-1/2 w-full flex justify-center items-center relative">
                            ...
                            <div class="inline-block absolute top-0 right-0">
                                <img src="./assets/images/all-img/discount.png" alt="">
    ...
    <section class="-mt-[75px] relative z-50">
        <div class="container px-3 md:px-5 xl:px-0">
            <div
                class="bg-white shadow-[0px_24px_100px_rgba(22,25,50,0.07)] rounded-xl xl:py-[50px] xl:px-[70px] p-8 mb-[26px]">
                <div class="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-4 sm:grid-cols-2 gap-6">
                    ...
                    <div class="feature-card flex gap-4 items-center w-full max-w-[280px]">
                        ...
                        <div>
                            <h3 class="text-lg leading-[110%] text-gray-black mb-1.5 font-medium">Great Support 24/7
                            </h3>
    ...
    <section class="xl:pb-20 pb-8 md:pb-12">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex flex-wrap justify-between items-center mb-10 px-2 xl:px-0">
                <h2
                    class="text-gray-black xl:text-[32px] xl:leading-[110%] text-xl md:text-2xl font-semibold font-display">
            ...
            <div class="swiper topCategoriesSwiper mx-3 md:mx-0">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="product-card-02">
                            <div class="product-thumb">
                                <a href="products.html"><img src="./assets/images/all-img/t-product-01.png"
                                        alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card-02">
                            <div class="product-thumb">
                                <a href="products.html"><img src="./assets/images/all-img/t-product-02.png"
                                        alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card-02">
                            <div class="product-thumb">
                                <a href="products.html"><img src="./assets/images/all-img/t-product-03.png"
                                        alt=""></a>
                            </div>
    ...
    <section class="lg:py-20 sm:py-8 py-6">
        <div class="container px-3 md:px-5 xl:px-0">
            <h2
                class="text-gray-black xl:text-[32px] xl:leading-[110%] text-xl md:text-2xl text-center font-semibold font-display mb-10">
                Our Products</h2>
    ...
    <section class="overflow-hidden lg:py-20 sm:py-8 py-5 bg-[#F0F2F3]">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex flex-wrap justify-between items-center mb-10">
                <h2
                    class="text-gray-black xl:text-[32px] xl:leading-[110%] text-xl md:text-2xl font-semibold font-display capitalize">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="product-details.html">
                                <div class="product-thumb">
                                    <img src="./assets/images/all-img/f-product-02.png" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="product-details.html">
                                <div class="product-thumb">
                                    <img src="./assets/images/all-img/f-product-03.png" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="product-details.html">
                                <div class="product-thumb">
                                    <img src="./assets/images/all-img/f-product-04.png" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
