<x-layouts.front>
    ...
    <section
        ...
        <div class="swiper bannerSwiper xl:pt-20 py-6 xl:pb-28 relative z-50">
            ...
            <div class="swiper-button-next banner-slider-button">
                <img src="./assets/images/svg/right.svg" alt="Next" class="w-6 h-6">
            </div>
            <div class="swiper-button-prev banner-slider-button">
                <img src="./assets/images/svg/left.svg" alt="Next" class="w-6 h-6">
            </div>
