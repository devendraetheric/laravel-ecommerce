                        ...
                        <table class="record-table">
                            ...
                            <tbody>
                                @forelse ($brands as $brand)
                                    <tr>
                                        <td class="!text-gray-900">{{ $brand->name }}</td>
                                        ...
                                        <td class="relative text-right text-sm space-x-1 items-center">
                                            ...
                                            <a href="javascript:;" class="link-danger relative inline-flex"
                                                @click="showDeleteModal = true; deleteActionURL='{!! route('admin.brands.destroy', $brand) !!}'">
                                                <svg viewBox="0 0 20 20" fill="currentColor" class="size-5">
                                                    <path fill-rule="evenodd"
